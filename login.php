				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent" >
					<ul class="navbar-nav mr-auto">
						...
						<form class="form-inline my-2 my-lg-0" method="post" name="Search_form" id="Search_form">
							...
							<button title="Nadom" class="btn my-2 my-sm-0"  > Search</button>
	  ...
	  <div class="row" >
		   ...
		   <form method="post">
		   	 <div class="form-group" >
		              <label for="NameR">Username or email</label>
		          <input type="text" class="form-control" id="NameR" placeholder="Enter username or email" name="NameR">
		            </div>
		            ...
		            <div class="form-group">
		            	<input type="button" name="login"  class="btn BotonFormulario"
		              value="Login" class="BotonFormulario" id="login" />
		            </div>
		            <div><p> Not registered yet? <a title="Rename" class="login" href="Register.php" > Register </a></p></div>
